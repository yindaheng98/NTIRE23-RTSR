...
CUDA_VISIBLE_DEVICES=0 python demo/sr_demo.py --submission-id SEU_CNIIx2bicubic \
  --checkpoint demo/PRFDN_x2.pth \
  --scale 2 \
  --lr-dir /home/data/dataset/NTIRE23-RTSR/LR2 \
  --save-sr --bicubic
CUDA_VISIBLE_DEVICES=0 python demo/sr_demo.py --submission-id SEU_CNIIx3bicubic \
